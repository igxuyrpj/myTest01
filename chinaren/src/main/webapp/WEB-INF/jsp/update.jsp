...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 ...
 <div class="index-main">
  ...
  <%--   <div style="margin-left: 500px;margin-top: 20px;">
   <form action="${pageContext.request.contextPath }/question/updateSave" method="post">
	<table border="1" width="300px" height="200px">
			...
			<tr>
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input style="width: 64px;height: 30px;"  type="submit" value="保存">
				</td>
 ...
 --%>	 <div class="index-newarticle mt10" style="height:600px;width:100%;border: 1px solid; ">
   ...
   <form action="${pageContext.request.contextPath }/chinaren/updateSave" method="post">
	...
	<tr>
			...
			<td><input style="height:20px; " id="school" type="text" name="school" value="${emp.school }"></td> 
			</tr>
			<tr>
				<td width="80px;">学号</td>
				<%-- <td><label>${emp.num }  </label></td> --%>
			 <td><input style="height:20px; " id="num" type="text" name="num" value="${emp.num }"></td> 
			</tr>
			<tr>
				<td>用户姓名</td>
				<%-- <td><label>${emp.name}  </label></td> --%>
			<td><input  style="height:20px; "  id="name"  type="text" name="name" value="${emp.name}"></td> 
			</tr>
			 
			<tr>
				<td> 专业</td>
				<%-- <td><label>${emp.major}</label></td> --%>
				 <td><input  style="height:20px; "  id="major"  type="text" name="major" value="${emp.major}"></td> 
			</tr>
			<tr>
				<td> 系别</td>
				<%-- <td><label>${emp.college}</label></td> --%>
			<td><input  style="height:20px; "  id="college"  type="text" name="college" value="${emp.college}"></td> 
			</tr>
			<tr>
				<td>班级</td>
				<%-- <td><label>${emp.class1}</label></td> --%>
			<td><input  style="height:20px; "  id="class1"  type="text" name="class1" value="${emp.class1}"></td> 
			</tr>
			<tr>
				<td> 联系方式</td>
				<%-- <td><label>${emp.phone}</label></td> --%>
			 <td><input  style="height:20px; "  id="phone"  type="text" name="phone" value="${emp.phone}"></td> 
			</tr>
			<tr>
				<td>年龄</td>
				<%-- <td><label>${emp.age}</label></td> --%>
			 <td><input  style="height:20px; "  id="age"  type="text" name="age" value="${emp.age}"></td> 
			</tr>
			<tr>
				<td>性别</td>
				<%-- <td><label>${emp.sex}</label></td> --%>
			<td><input  style="height:20px; "  id="sex"  type="text" name="sex" value="${emp.sex}"></td> 
			</tr>
			<tr>
				<td>入学时间</td>
				<%-- <td><label>${emp.date}</label></td> --%>
			<td><input  style="height:20px; "  id="date"  type="text" name="date" value="${emp.date}"></td> 
			</tr>
