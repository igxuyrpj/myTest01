...
<div id="toptool" class="top-nav">
	<div class="container">
		...
		<div class="login-pane">
			<button class="btn btn-mini pane" onclick="window.location.href='login.jsp'">&nbsp;&nbsp;个人登录</button>
...
<div class="container main mt20">
   ...
   <!--注册开始-->
    <div class="reg">
        <form action="${pageContext.request.contextPath}/register" method="post" name="form1" id="form1">
            <dl>
                <dt class="f14 b">帐户基本信息</dt>
               <dd><span class="title"> 姓名：</span><input name="iptName" id="iptName" class="reg_input" type="text" onblur="return isCnn(this)" /><span id="iptNameTip" class="onshow"></span></dd>
                <dd><span class="title">身份证号：</span><input class="reg_input" name='iptCard' type='text' id='iptCard' onblur="return checktheform();" /><span id="iptCardTip" class="onshow"></span></dd><span id="checkResult"></span>
                
                <dd><span class="title">手机号码：</span><input type="tel" name="phone" required pattern="1\d{10}"><span class="onshow"></span></dd>
            ...
            <div class="f_reg_but"><input id="button" name="button" type="submit" value="立即注册"/><span class="clew_txt">如果您已有帐号，可<a href="index.jsp">直接登录</a></span></div>
        </form>                              
    </div>
     </div>
<!--注册结束-->     
