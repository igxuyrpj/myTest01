...
<div class="container main mt20">
   ...
   <form action="${pageContext.request.contextPath }/driver/updateSave" method="post">
	<table border="1" width="375px" height="400px" style="text-align: center;">
			<tr>
				<td width="80px;">序号</td>
				<%--<td><label name="id">${emp.id}  </label></td> --%>
				  <td><input style="height:45px;font-size: 23px;text-align: center; " id="id" type="text" name="id" value="${emp.id }"></td> 
			</tr>
			<tr>
				<td width="80px;">用户名</td>
				<td><label name="name">${emp.name}  </label></td> 
				<%--  <td><input style="height:20px; " id="id" type="text" name="id" value="${emp.id }"></td>--%> 
			</tr>
			<tr>
				<td width="80px;">身份证号码</td>
				 <td><label name="idCard">${emp.idCard }  </label></td> 
				<%-- <td><input style="height:20px; " id="id" type="text" name="id" value="${emp.id }"></td> --%>
			</tr>
			<tr>
				<td>手机号码</td>
				<%-- <td><label>${emp.subject}  </label></td> --%>
				 <td><input  style="height:45px;font-size: 23px;text-align: center; "  id="username"  type="text" name="phone" value="${emp.phone}"></td>
			</tr>
			 
			<tr>
				<td>密码</td>
				<%-- <td><label>${emp.date}</label></td>--%>
				<td><input  style="height:45px;font-size: 23px;text-align: center;  "  id="userpassword"  type="text" name="pwd" value="${emp.pwd}"></td> 
			</tr>
			<%-- <tr>
				<td> 时间</td>
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<button type="submit" style="width: 84px;height: 30px;">确&nbsp;  定</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
