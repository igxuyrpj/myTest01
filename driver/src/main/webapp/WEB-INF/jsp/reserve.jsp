...
<div class="header_body ui-header">
	<div class="container">
		<div class="row">
			...
			<div id="mainnav" class="main-nav span7 taR"style="color: black;">
...
<div class="container main mt20">
    ...
    <div class="row" style=" height:337px; width:1083px; background: #fff url(../static/css/images/login-bg1.jpg) right bottom no-repeat;">
    <!--登录开始-->
    
    <div >
    <form action="${pageContext.request.contextPath}/driver/subject" method="post">
	<fieldset ">
		<legend>预约时间</legend>
		
		<label for="">
			选择科目: <input style="height: 40px;"  type="text" name="subject" list="course" placeholder="选择考试科目">
			<datalist id="course">
		...
		<label for="">
			选择日期: <input style="height: 40px;" type="date" name="date" value="2018-06-01">
		</label>
				<!--主体开始-->

             <label for="">
              选择时间:<input style="height: 40px;" type="text" name="datepicker" id="datetimepicker1" class="form-control" value="9:00"/>
               </label>
...
$(function (){
	...
	$("#datetimepicker3").on("click",function(e){
		...
		<label for="" class="btn">
		<input style="width: 374px;" type="submit" value="提交">
		</label>
