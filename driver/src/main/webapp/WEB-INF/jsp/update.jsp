   ...
   <form action="${pageContext.request.contextPath }/driver/updateSave" method="post">
	<table border="1" width="375px" height="400px" style="text-align: center;">
			<tr>
				...
				<td><input style="height:45px; " id="id" type="text" name="id" value="${emp.id }"></td>
			</tr>
			<tr>
				<td width="80px;">用户名</td>
				<%-- <td><label>${emp.name}  </label></td> --%>
				<td><input style="height:45px; " id="id" type="text" name="name" value="${emp.name}"></td>
			</tr>
			<tr>
				<td width="80px;">身份证号码</td>
					<%-- <td><label>${emp.idCard }  </label></td>--%>
			<td><input style="height:45px; " id="id" type="text" name="idCard" value="${emp.idCard }"></td> 
			</tr>
			<tr>
				<td>手机号码</td>
				<%-- <td><label>${emp.subject}  </label></td>--%>
				<td><input  style="height:45px; "  id="username"  type="text" name="phone" value="${emp.phone}"></td> 
			</tr>
			 
			<tr>
				<td> 密码</td>
				<%--<td><label>${emp.date}</label></td> --%>
				 <td><input  style="height:45px; "  id="userpassword"  type="text" name="pwd" value="${emp.pwd}"></td>
			</tr>
